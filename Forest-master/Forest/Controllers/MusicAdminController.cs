    ...
    public MusicAdminController()
    {
        ...
        public ActionResult AddMusicRecording ( Music_Recording recording )
        {
            try
            {
                ...
                return RedirectToAction("GetMusicRecordings", new { Controller = "Music", genre = recording.Genre  });
            }
            catch
            {
                return View();
        ...
        public ActionResult DeleteMusicRecording(Music_Recording recording)
        {
            try
            {
                ...
                return RedirectToAction("GetMusicRecordings", new { controller = "Music", genre = _recording.Genre });
